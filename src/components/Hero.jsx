...
const Hero = () => (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
        ...
        <div className={` flex-1 ${styles.flexStart}  flex-col xl:px-0 sm:px-16 px-6`}>
            ...
            <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum corporis dolorem asperiores soluta necessitatibus nostrum voluptatum cumque fuga totam ratione!</p>
        </div>
        <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
            <img src={robot} alt="robort" className=' w-[100%] h-[100%] relative z-[5]' />
